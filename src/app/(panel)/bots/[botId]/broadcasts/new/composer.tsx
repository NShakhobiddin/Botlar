...
export function Composer({
  ...
  const [state, formAction] = useActionState<ActionState, FormData>(createAction, {});
      ...
      <div className="space-y-5">
        <Card>
          ...
          <div className="space-y-4 p-5">
            <Field label="Nomi" hint="Faqat panelda ko'rinadi — tarixda topish uchun.">
              <input name="name" placeholder="Yangi yil aksiyasi" />
            </Field>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <Field label="Format">
                <select name="parseMode" defaultValue="HTML">
              ...
              <Field label="Media turi">
                <select name="mediaType" defaultValue="NONE">
              ...
              <Field label="Media havolasi">
                <input name="mediaUrl" placeholder="https://…" className="font-mono text-xs" />
              </Field>
            </div>

            <Field
              label="Tugmalar"
              hint="Har qatorda bittadan: Matn | https://havola"
            >
              <textarea
                name="buttons"
                rows={3}
        ...
        <Card>
          ...
          >
              ...
              <div className="flex flex-wrap gap-4 pt-1">
                {locales.map((l) => (
                  <label key={l} className="flex items-center gap-2 text-sm">
                    <input type="checkbox" name="locales" value={l} />
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <Field label="Faollik">
                <select name="activeDays" defaultValue="">
              ...
              <Field label="Qo'shilgan — dan">
                <input type="date" name="joinedAfter" />
              </Field>
              <Field label="Qo'shilgan — gacha">
                <input type="date" name="joinedBefore" />
              </Field>
            </div>

            <div className="flex flex-wrap gap-5 text-sm">
              <label className="flex items-center gap-2">
                <input type="checkbox" name="openedWebApp" />
        ...
        <Notice state={state} />
        <SubmitButton pendingLabel="Saqlanmoqda…">Qoralamani saqlash</SubmitButton>
      </div>
